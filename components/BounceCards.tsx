  ...
  const handleCardClick = (idx: number) => {
    ...
    if (isMobile) {
      if (activeCardIndex === idx) {
        ...
        // First tap - show animation only
        pushSiblings(idx);
        setActiveCardIndex(idx);
      }
    } else {
      // On desktop, click immediately opens popup
      onCardClick(idx);
    }
  };
    ...
    >
      {images.map((src, idx) => (
        <div
          ...
          onMouseEnter={() => enableHover && !isMobile && pushSiblings(idx)}
          onMouseLeave={() => enableHover && !isMobile && resetSiblings()}
